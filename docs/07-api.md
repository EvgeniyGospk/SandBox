...
> Статус: backend/API в этом репозитории сейчас отсутствует.
> Этот документ описывает целевую спецификацию (roadmap) и не является отражением текущей реализации.
